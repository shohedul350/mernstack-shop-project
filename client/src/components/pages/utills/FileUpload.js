...
function FileUpload(props) {
  const [Images,setImages]=useState([])
    ...
    const onDrop = (files) => {
        ...
        Axios.post('http://localhost:5000/api/product/uploadImage', formData, config)
            .then(response => {
...
{({ getRootProps, getInputProps }) => (
       <div className="border " style={{width:'250px',height:'250px',alignItems:'center',justifyContent:'center',display:'flex'}}
       {...getRootProps()}
